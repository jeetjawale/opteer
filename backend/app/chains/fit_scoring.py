...
def get_fit_scoring_chain(user_api_key: str | None = None, model_override: str | None = None):
    """
    ...
    llm = app.llm.get_llm(temperature=0.0, max_tokens=1200, model_override=model_override or settings.AI_MODEL_FIT, user_api_key=user_api_key)
