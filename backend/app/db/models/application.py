...
from sqlalchemy import String, DateTime, Date, Integer, Boolean, text, ForeignKey, UniqueConstraint, Index
...
class Application(Base):
    ...
    # Quality Gate
    is_quality_gated: Mapped[bool | None] = mapped_column(Boolean, server_default=text("false"))
