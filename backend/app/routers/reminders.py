...
async def list_reminders(
    ...
    """
    async with log_duration("LIST_REMINDERS"):
        try:
...
async def create_reminder(
    ...
    """
    async with log_duration("CREATE_REMINDER"):
...
async def update_reminder(
    ...
    """
    async with log_duration("UPDATE_REMINDER"):
...
async def delete_reminder(
    ...
    """
    async with log_duration("DELETE_REMINDER"):
        # 1. Verify ownership
        try:
            check_response = await asyncio.to_thread(
                lambda: supabase_service.table("reminders")
